...
class App{
    ...
    initPages() {
        ...
        propertyPage
            ...
            .click(()=>{
                let t = this.#totalMax;
                const arr = [pointNum, pointNum, pointNum, pointNum];
                while(t>0) {
                    const sub = Math.round(Math.random() * (Math.min(t, pointNum) - 1)) + 1;
                    while(true) {
                ...
                groups.CHR.set(pointNum - arr[0]);
                groups.INT.set(pointNum - arr[1]);
                groups.STR.set(pointNum - arr[2]);
                groups.MNY.set(pointNum - arr[3]);
            });
